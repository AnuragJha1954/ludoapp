"""
Django settings for ludoapp project.
...
SECRET_KEY = 'django-insecure-oislv!bhjofhcg200_!1r89fbrol+!=xi_=a+ns68n(knbreh_'
...
WSGI_APPLICATION = 'ludoapp.wsgi.application'
